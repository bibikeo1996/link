...
function expxortLink(data){
    ...
    var today1 = new Date();
    var filename1 = "Link" + '-' + today1.getDate() + '-' +(today1.getMonth()+1) + '-' + today1.getFullYear() +'.xlsx';
...
(async () => {
    ...
    for (var rs of urls) { // open for 1
        try { // open try 1
            ...
            await page.goto("https://www.bing.com/search?q="+rs.Model+" nguyenkim",{waitUntil: 'load', timeout: 100000});
                		...
                		if(checkweb !== null){
                			function CheckSieuThi(){
                				...
                				for(var i = 0; i < checklink.length; i++){
                					...
                					if(data.includes("nguyenkim")){
                						res.push(data);
                					}else{
                						res.push("https://www.nguyenkim.com/");
                					}
                				}return res;
                			} // end function
                			...
                			return {
		                        Link: link ? link : "https://www.nguyenkim.com/",
		                    }
                		}
                		return {
